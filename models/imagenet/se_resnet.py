...
def se_resnet18(num_classes=1000, **kwargs):
...
def se_resnet34(num_classes=1000, **kwargs):
...
def se_resnet50(num_classes=1000, **kwargs):
...
def se_resnet101(num_classes=1000, **kwargs):
...
def se_resnet152(num_classes=1000, **kwargs):
