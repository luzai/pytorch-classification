...
parser.add_argument('--train-batch', default=64 * 4, type=int, metavar='N',
                    help='train batchsize (default: 256)')
parser.add_argument('--test-batch', default=32 * 4, type=int, metavar='N',
...
# Checkpoints
parser.add_argument('-c', '--checkpoint', default='work/bak', type=str, metavar='PATH',
...
class ImageFolder(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        try:
            ...
            print(path)
            lz.logging.error('plss rm {}'.format(path))
